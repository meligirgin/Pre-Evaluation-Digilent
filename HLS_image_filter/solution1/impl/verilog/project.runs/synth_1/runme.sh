...
HD_PWD='C:/Users/melik/eclipse-workspace/threshold1/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_filter.tcl
