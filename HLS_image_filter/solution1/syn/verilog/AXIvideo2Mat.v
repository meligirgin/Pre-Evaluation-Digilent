...
wire   [0:0] exitcond3_i_fu_416_p2;
...
wire  signed [10:0] rows_V_fu_399_p0;
wire  signed [11:0] cols_V_fu_403_p0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond3_i_fu_416_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_427_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond3_i_fu_416_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((exitcond3_i_fu_416_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign exitcond3_i_fu_416_p2 = ((t_V_reg_273 == rows_V_reg_479) ? 1'b1 : 1'b0);

assign exitcond_i_fu_427_p2 = ((t_V_3_reg_284 == cols_V_reg_484) ? 1'b1 : 1'b0);
...
assign j_V_fu_432_p2 = (t_V_3_reg_284 + 32'd1);
