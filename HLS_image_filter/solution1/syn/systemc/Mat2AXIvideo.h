...
struct Mat2AXIvideo : public sc_module {
    ...
    sc_signal< sc_lv<1> > exitcond_reg_232;
    sc_signal< sc_logic > OUTPUT_STREAM_TDATA_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter2;
    sc_signal< sc_lv<1> > exitcond_reg_232_pp0_iter1_reg;
    sc_signal< sc_lv<11> > t_V_2_reg_152;
    sc_signal< sc_lv<1> > exitcond2_fu_168_p2;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< bool > ap_block_state2;
    sc_signal< sc_lv<10> > i_V_fu_174_p2;
    sc_signal< sc_lv<10> > i_V_reg_227;
    ...
    sc_signal< sc_lv<11> > j_V_fu_186_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<1> > axi_last_V_fu_192_p2;
    sc_signal< sc_lv<1> > axi_last_V_reg_241;
    sc_signal< sc_lv<24> > p_Result_s_fu_202_p3;
    sc_signal< bool > ap_block_pp0_stage0_subdone;
    sc_signal< sc_logic > ap_condition_pp0_exit_iter0_state3;
    sc_signal< sc_lv<10> > t_V_reg_141;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_logic > ap_CS_fsm_state6;
    sc_signal< sc_lv<1> > tmp_user_V_fu_102;
    ...
    void thread_p_Result_s_fu_202_p3();
